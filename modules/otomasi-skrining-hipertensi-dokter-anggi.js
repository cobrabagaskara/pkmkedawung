// ==UserScript==
// @name         Otomasi Skrining Hipertensi - Dokter Anggi
// @namespace    https://cirebon.epuskesmas.id
// @version      1.0
// @description  Otomasi pengisian form skrining hipertensi - Data terbaru dari recording
// @author       You
// @match        https://cirebon.epuskesmas.id/skrininghipertensi/create/*
...
(function() {
    ...
    const screeningData = {
        "metadata": {
            "url": "https://cirebon.epuskesmas.id/skrininghipertensi/",
            "skrining": "Hipertensi",
            "judul": "Skrining Hipertensi",
            "recordedAt": "2026-01-28T07:08:49.971Z",
            "totalActions": 8
        },
        "actions": [
            {
                "type": "setRadio",
                "name": "riwayat_pribadi",
                "value": "Tidak",
                "time": "2026-01-28T07:08:08.757Z"
            },
            {
                "type": "setRadio",
                "name": "riwayat_keluarga",
                "value": "Tidak",
                "time": "2026-01-28T07:08:09.720Z"
            },
            {
                "type": "setRadio",
                "name": "riwayat_merokok",
                "value": "Tidak",
                "time": "2026-01-28T07:08:10.480Z"
            },
            {
                "type": "setRadio",
                "name": "riwayat_alkohol",
                "value": "Tidak",
                "time": "2026-01-28T07:08:11.312Z"
            },
            {
                "type": "setRadio",
                "name": "makan_asin",
                "value": "Tidak",
                "time": "2026-01-28T07:08:13.883Z"
            },
            {
                "type": "setRadio",
                "name": "aktifitas_fisik",
                "value": "Tidak",
                "time": "2026-01-28T07:08:14.872Z"
            },
            {
                "type": "setRadio",
                "name": "istirahat_cukup",
                "value": "Ya",
                "time": "2026-01-28T07:08:16.390Z"
            },
            {
                "type": "setRadio",
                "name": "kurang_buah_sayur",
                "value": "Tidak",
                "time": "2026-01-28T07:08:20.870Z"
            }
        ]
    };
    ...
    async function runAutomation() {
        log('🚀 === MEMULAI OTOMASI SKRINING HIPERTENSI ===', 'info');
    ...
    function showNotification(success, fail, validation) {
        ...
        if (typeof GM_notification !== 'undefined') {
            GM_notification({
                title: '✅ Otomasi Skrining Hipertensi Selesai',
                text: message,
                timeout: 8000,
                onclick: () => {
    ...
    function addButton() {
        ...
        button.innerHTML = `
            <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <div style="text-align: left;">
                    ...
                    <div style="font-size: 11px; opacity: 0.9;">Skrining Hipertensi</div>
                </div>
            </div>
        `;
        ...
        button.onmouseover = () => {
            ...
            button.style.boxShadow = '0 8px 25px rgba(255, 65, 108, 0.6)';
        };

        button.onmouseout = () => {
            button.style.transform = 'translateY(0) scale(1)';
            button.style.boxShadow = '0 6px 20px rgba(255, 65, 108, 0.4)';
        };
    ...
    // INITIALIZATION
    // =====================================
    log('Intialized Tampermonkey - Otomasi Skrining Hipertensi v1.0', 'info');
