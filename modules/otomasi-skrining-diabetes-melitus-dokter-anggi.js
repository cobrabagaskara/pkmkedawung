// ==UserScript==
// @name         Otomasi Skrining Diabetes Melitus - Dokter Anggi
// @namespace    https://cirebon.epuskesmas.id
// @version      1.0
// @description  Otomasi pengisian form skrining diabetes melitus - Data terbaru dari recording
// @author       You
// @match        https://cirebon.epuskesmas.id/skriningdiabetesmelitus/create/*
...
(function() {
    ...
    const screeningData = {
        "metadata": {
            "url": "https://cirebon.epuskesmas.id/skriningdiabetesmelitus/",
            "skrining": "Diabetes Melitus",
            "judul": "Formulir Skrining Diabetes Melitus",
            "recordedAt": "2026-01-28T07:20:02.793Z",
            "totalActions": 13
        },
        "actions": [
            {
                "type": "setRadio",
                "name": "anamnesis[Sering lapar]",
                "value": "0",
                "time": "2026-01-28T07:19:17.003Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Sering haus]",
                "value": "0",
                "time": "2026-01-28T07:19:17.808Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Sering BAK/mengompol]",
                "value": "0",
                "time": "2026-01-28T07:19:18.449Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Penurunan Berat Badan 2-6 minggu terakhir]",
                "value": "0",
                "time": "2026-01-28T07:19:19.064Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Riwayat Pribadi Diabetes Melitus]",
                "value": "0",
                "time": "2026-01-28T07:19:19.712Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Riwayat Keluarga Diabetes Melitus]",
                "value": "0",
                "time": "2026-01-28T07:19:20.272Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Riwayat Merokok]",
                "value": "0",
                "time": "2026-01-28T07:19:21.031Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Riwayat Minum alkohol/Merokok di keluarga]",
                "value": "0",
                "time": "2026-01-28T07:19:34.786Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Kebiasaan makan manis]",
                "value": "0",
                "time": "2026-01-28T07:19:35.653Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Aktifitas fisik setiap hari]",
                "value": "0",
                "time": "2026-01-28T07:19:36.432Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Istirahat cukup]",
                "value": "1",
                "time": "2026-01-28T07:19:38.120Z"
            },
            {
                "type": "setRadio",
                "name": "anamnesis[Kurang Makan Buah dan Sayur]",
                "value": "0",
                "time": "2026-01-28T07:19:41.984Z"
            },
            {
                "type": "setValue",
                "name": "skor",
                "value": "1",
                "time": "2026-01-28T07:19:54.280Z"
            }
        ]
    };
    ...
    // =====================================
    // SET RADIO BUTTON (Handle bracket notation)
    // =====================================
    ...
    async function runAutomation() {
        log('🚀 === MEMULAI OTOMASI SKRINING DIABETES MELITUS ===', 'info');
    ...
    function showNotification(success, fail, validation) {
        ...
        if (typeof GM_notification !== 'undefined') {
            GM_notification({
                title: '✅ Otomasi Skrining Diabetes Melitus Selesai',
                text: message,
                timeout: 8000,
                onclick: () => {
    ...
    function addButton() {
        ...
        button.innerHTML = `
            <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <div style="text-align: left;">
                    ...
                    <div style="font-size: 11px; opacity: 0.9;">Skrining Diabetes</div>
                </div>
            </div>
        `;
        ...
        button.onmouseover = () => {
            ...
            button.style.boxShadow = '0 8px 25px rgba(161, 140, 209, 0.6)';
        };

        button.onmouseout = () => {
            button.style.transform = 'translateY(0) scale(1)';
            button.style.boxShadow = '0 6px 20px rgba(161, 140, 209, 0.4)';
        };
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        `;
                        button.style.background = 'linear-gradient(135deg, #a18cd1 0%, #fbc2eb 100%)';
                    }, 3000);
                }, 500);
            }
        };
    ...
    function autoRunIfNeeded() {
        ...
        /*
        const autoRunUrls = [
            '/skriningdiabetesmelitus/create/'
        ];
    ...
    // INITIALIZATION
    // =====================================
    log('Intialized Tampermonkey - Otomasi Skrining Diabetes Melitus v1.0', 'info');
